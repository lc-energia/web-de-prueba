...
// Icon Components
const SolarPanelIcon = () => <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 10h16M4 14h16M4 18h16M5 3l14 18"></path></svg>;
const WindIcon = () => <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10m-2.121 2.121A8.003 8.003 0 0112 4.5a8.003 8.003 0 017.778 5.378M3 12h5m4 0h9"></path></svg>;
const LightbulbIcon = () => <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.707.707M12 21v-1m-4.657-3.343l.707-.707"></path></svg>;
const HeadsetIcon = () => <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>;
const CheckCircleIcon = () => <svg className="w-5 h-5 text-primary mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>;
      ...
      <section className="py-16 sm:py-20 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center max-w-3xl mx-auto mb-12"
          >
            <h6 className="text-secondary font-bold text-lg uppercase tracking-wider">Produzione di energia pulita per salvare l’ambiente</h6>
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center max-w-3xl mx-auto mb-12"
          >
            <h6 className="text-secondary font-bold text-lg uppercase tracking-wider">Collaborazioni</h6>
          </motion.div>
          <motion.div 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 mb-12">
              <div className="space-y-2 text-gray-700">
                <p>Iscritti ai rispettivi Albi Professionali Provinciali</p>
                <p>Certificatori Energetici di cui al D.G.R. 8/5018 – 20.07.2007</p>
                <p>Accreditati Energy Building Manager, Regione Lombardia ai sensi del D.G.R. VIII/8355 del 5 Novembre 2008</p>
                <p>Iscritti nell’elenco dei progettisti antincendio del Ministero dell’Interno di cui al D.Lgs n.139/2006 (ex Legge 818/84)</p>
                <p>Verificatori in materia di sicurezza degli impianti ai sensi del DM 22/1/08 n. 37</p>
                <p>Consulenti tecnici del Tribunale di Monza</p>
              </div>
          </div>
          <motion.div
            variants={fadeIn('up', 0.2)}
            ...
            className="text-center max-w-3xl mx-auto mb-12"
          >
            <h6 className="text-secondary font-bold text-lg uppercase tracking-wider">Membri del Team Esperti</h6>
          </motion.div>
